...
public class ResultsActivity extends ActionBarActivity implements
	...
	public static ArrayList<FileItem> items;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (FileItem fileItem : items){
			...
			fileItem.mRank = String.valueOf(rRank);
		}
	...
	public class rankComparator implements Comparator<FileItem> {
		...
		public int compare(FileItem item1, FileItem item2) {
			return (Integer.valueOf(item1.mRank) > Integer.valueOf(item2.mRank)) ? -1 : 1;
		}
	}
	private class FilesListAdapter extends ArrayAdapter<FileItem> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			ImageButton aPlus = (ImageButton) rowView.findViewById(R.id.aplus);
	...
	private class ButtonListner implements View.OnClickListener {
		...
		public void onClick(View v) {
			Toast.makeText(ResultsActivity.this, "Click!", Toast.LENGTH_SHORT)
					.show();
		}
	}
	...
	private class SearchListner implements View.OnClickListener {
		...
		public void onClick(View v) {
			// Open Results
			Intent searchIntent = new Intent(ResultsActivity.this,
					SearchActivity.class);
			ResultsActivity.this.startActivity(searchIntent);
	...
	private class TrendingListner implements View.OnClickListener {
		...
		public void onClick(View v) {
			// Open Results
			Intent trendingIntent = new Intent(ResultsActivity.this,
					TrendingActivity.class);
			ResultsActivity.this.startActivity(trendingIntent);
			ResultsActivity.this.finish();
